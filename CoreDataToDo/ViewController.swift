...
//  CoreDataToDo
//
//  Created by Gil Rodarte on 14/01/18.
...
class ViewController: UITableViewController {
    ...
    func save(_ itemName: String) {
        ...
        do {
            ...
            print("Error al intentar guardar los datos", err)
        }
        
    }
    
    @objc func addItem(_ sender: AnyObject) {
        let alertController = UIAlertController(title: "Añadir a lista", message: "Introduce lo que quieres", preferredStyle: .alert)
